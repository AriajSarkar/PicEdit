 ...
 */
export function chunked_download(url, chunk_size, db_name, store_name, progress_callback) {
    const ptr0 = passStringToWasm0(url, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(db_name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(store_name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.chunked_download(ptr0, len0, chunk_size, ptr1, len1, ptr2, len2, addHeapObject(progress_callback));
 ...
 */
export function clear_cache(db_name, store_name) {
    const ptr0 = passStringToWasm0(db_name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(store_name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.clear_cache(ptr0, len0, ptr1, len1);
    return takeObject(ret);
}
 ...
 * @returns {Promise<ArrayBuffer>}
 */
export function get_cached(url, db_name, store_name) {
    const ptr0 = passStringToWasm0(url, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(db_name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(store_name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.get_cached(ptr0, len0, ptr1, len1, ptr2, len2);
    return takeObject(ret);
}
 ...
 */
export function is_cached(url, db_name, store_name) {
    const ptr0 = passStringToWasm0(url, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(db_name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(store_name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.is_cached(ptr0, len0, ptr1, len1, ptr2, len2);
    return takeObject(ret);
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_b5d9e2fb389fef91: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return __wasm_bindgen_func_elem_248(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_64, __wasm_bindgen_func_elem_65);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 28, function: Function { arguments: [Externref], shim_idx: 2, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_951, __wasm_bindgen_func_elem_65);
            return addHeapObject(ret);
        },
...
function __wasm_bindgen_func_elem_65(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_65(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_248(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_248(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
