/* @ts-self-types="./post_refinement.d.ts" */
 ...
 * @param {Uint8Array} mask_rgba
 * @param {Uint8Array} original_rgba
 * @param {number} width
 * @param {number} height
 * @param {number} guide_radius
 * @param {number} guide_eps
 * @param {number} edge_threshold
 * @param {number} feather_radius
 * @returns {Uint8Array}
 */
export function post_process(mask_rgba, original_rgba, width, height, guide_radius, guide_eps, edge_threshold, feather_radius) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(mask_rgba, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(original_rgba, wasm.__wbindgen_export);
        const len1 = WASM_VECTOR_LEN;
        wasm.post_process(retptr, ptr0, len0, ptr1, len1, width, height, guide_radius, guide_eps, edge_threshold, feather_radius);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('post_refinement_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
