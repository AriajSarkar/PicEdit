...
export { fileToDataUrl, getImageInfo } from '@/lib/imageUtils';
...
// CRC32 imported from shared module (see imports above)
...
// generateId, formatBytes, estimateDataUrlSize, calculateCompressionPercent
// are now imported from @/lib/imageUtils (see imports above)
