...
// ── Types (duplicated — workers can't use @/ aliases) ───────────────────────
// @see src/img-resizer/types/index.ts (canonical source)
...
// @see src/img-resizer/lib/dimensions.ts (canonical source for dimension calc functions)
