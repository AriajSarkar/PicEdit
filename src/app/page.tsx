...
export default function Home() {
	return (
		<div className="min-h-screen bg-background text-foreground relative overflow-hidden">
			{/* Background glow — radial-gradient avoids costly 120px blur */}
			<div
			...
			{/* Nav */}
			<header className="sticky top-0 z-50 glass border-b border-white/4">
				<div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
					...
					<div className="flex sm:hidden items-center gap-1">
						<Link
							href="/bg-remover"
							className="px-2.5 py-2 text-xs font-medium text-secondary hover:text-foreground hover:bg-white/5 rounded-lg transition-all"
						>
							BG
						</Link>
						<Link
						...
						<a
							...
							target="_blank"
							rel="noopener noreferrer"
							className="p-2.5 text-secondary hover:text-foreground transition-colors"
						>
