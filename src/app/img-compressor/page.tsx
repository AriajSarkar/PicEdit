      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-[var(--muted)] text-sm max-w-md mx-auto">
            Compress images up to 90% smaller using production-grade algorithms. Everything runs
              ...
              <>
                      ...
                      >
                        {isProcessing ? (
                          <span className="flex items-center gap-2">
                            <svg className="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24" aria-hidden="true" focusable={false}>
                              <circle
                ...
                {pendingCount > 0 && (
                  ...
                  >
                    ...
                    <span className="text-xs text-[var(--muted)]">Based on current settings</span>
                  </motion.div>
                )}
          ...
          {hasItems && (
            ...
            >
              <div className="glass rounded-xl p-5 sticky top-20">
                ...
                <CompressionControls config={config} onChange={setConfig} disabled={isProcessing} />
              </div>
            </motion.div>
          )}
        </div>
