          ...
          <div className="space-y-6">
            ...
            {hasItems && sourceWidth > 0 && (
              <motion.button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-[var(--accent)]/30 hover:bg-[var(--bg-elevated)] transition-all group"
              >
                <div className="w-9 h-9 rounded-lg bg-[var(--accent)]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[var(--accent)]/15 transition-colors">
                  <svg
                    className="w-4.5 h-4.5 text-[var(--accent)]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={2}
                ...
                <div className="flex-1 text-left">
                  ...
                  <p className="text-[10px] text-[var(--text-muted)] mt-0.5">
                    Drag handles, zoom, pan &mdash; interactive resize with preview
                  </p>
                </div>
                <svg
              ...
              <>
                ...
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    {doneCount > 0 && (
                      <button onClick={downloadAll} className="btn-secondary text-sm px-4 py-2">
                ...
                {stats.doneCount > 0 && <ResizeSummary stats={stats} totalCount={items.length} />}
              </>
            )}
          </div>
  ...
  return (
    ...
    >
      ...
      <p className="text-[var(--text-muted)] text-sm max-w-md mx-auto">
        Resize images to exact dimensions, percentages, or social media presets. Everything runs
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-3">
        <span className="text-sm font-medium text-[var(--foreground)]">Resize Summary</span>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          <p className="text-xs text-[var(--text-muted)] mb-0.5">Original</p>
          <p className="text-sm font-mono text-[var(--foreground)]">{stats.formattedOriginal}</p>
        </div>
        <div>
          <p className="text-xs text-[var(--text-muted)] mb-0.5">Resized</p>
          <p className="text-sm font-mono text-[var(--foreground)]">{stats.formattedResized}</p>
        </div>
        <div>
          <p className="text-xs text-[var(--text-muted)] mb-0.5">Difference</p>
          <p
